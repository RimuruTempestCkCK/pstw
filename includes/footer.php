    ...
    ***********************************-->
    ...
    <script src="<?php echo $base_url; ?>js/quixnav-init.js"></script>
    <script src="<?php echo $base_url; ?>js/custom.min.js"></script>


    <!-- Vectormap -->
    <script src="<?php echo $base_url; ?>vendor/raphael/raphael.min.js"></script>
    <script src="<?php echo $base_url; ?>vendor/morris/morris.min.js"></script>


    <script src="<?php echo $base_url; ?>vendor/circle-progress/circle-progress.min.js"></script>
    <script src="<?php echo $base_url; ?>vendor/chart.js/Chart.bundle.min.js"></script>

    <script src="<?php echo $base_url; ?>vendor/gaugeJS/dist/gauge.min.js"></script>
    ...
    <!-- Counter Up -->
    <script src="<?php echo $base_url; ?>vendor/jqvmap/js/jquery.vmap.min.js"></script>
    <script src="<?php echo $base_url; ?>vendor/jqvmap/js/jquery.vmap.usa.js"></script>
