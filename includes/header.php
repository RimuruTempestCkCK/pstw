...
<head>
    ...
    <title>Sistem Prediksi Pola Perilaku Lansia</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo $base_url; ?>images/favicon.png">
    <link rel="stylesheet" href="<?php echo $base_url; ?>vendor/owl-carousel/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo $base_url; ?>vendor/owl-carousel/css/owl.theme.default.min.css">
    <link href="<?php echo $base_url; ?>vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <span class="mr-2"><?php echo $_SESSION['nama']; ?> (<?php echo ucfirst($_SESSION['role']); ?>)</span>
